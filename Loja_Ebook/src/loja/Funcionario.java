...
public class Funcionario extends Pessoa {
	...
	public static void quantidadeVendas(ArrayList<Venda> vendas) {
		Venda vend;
		Main.limpaTela(7);
		System.out.println( " a Quantidade de vendas de PDF do Funcionário é " );
		for(int aux = 0;aux < vendas.size(); aux++) {
        	vend = (Venda) vendas.get(aux);
            System.out.println(vend.venda+"\t\t"+""
            		);
